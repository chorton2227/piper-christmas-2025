# Exercise 3: Full House Detector 🎯

## Objective

In this exercise, you'll practice implementing **Full House Detector** as part of the Hand Evaluation Part 2 lesson.

## Requirements

Create a working implementation that:
1. Implements the core functionality for Full House Detector
...
- Write the JavaScript functions for Full House Detector
