# Exercise 3: Handle All-Ins 🎯

## Objective

In this exercise, you'll practice implementing **Handle All-Ins** as part of the Betting System lesson.

## Requirements

Create a working implementation that:
1. Implements the core functionality for Handle All-Ins
...
- Write the JavaScript functions for Handle All-Ins
