# Exercise 2: Manage Players 🎯

## Objective

In this exercise, you'll practice implementing **Manage Players** as part of the Game State Management lesson.

## Requirements

Create a working implementation that:
1. Implements the core functionality for Manage Players
...
- Write the JavaScript functions for Manage Players
