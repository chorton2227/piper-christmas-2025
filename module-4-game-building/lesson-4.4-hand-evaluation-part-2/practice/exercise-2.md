# Exercise 2: Flush Finder 🎯

## Objective

In this exercise, you'll practice implementing **Flush Finder** as part of the Hand Evaluation Part 2 lesson.

## Requirements

Create a working implementation that:
1. Implements the core functionality for Flush Finder
...
- Write the JavaScript functions for Flush Finder
