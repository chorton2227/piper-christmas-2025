# Exercise 1: Straight Checker 🎯

## Objective

In this exercise, you'll practice implementing **Straight Checker** as part of the Hand Evaluation Part 2 lesson.

## Requirements

Create a working implementation that:
1. Implements the core functionality for Straight Checker
...
- Write the JavaScript functions for Straight Checker
