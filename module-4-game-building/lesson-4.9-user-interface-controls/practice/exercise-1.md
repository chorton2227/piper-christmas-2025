# Exercise 1: Create Poker Table UI 🎯

## Objective

In this exercise, you'll practice implementing **Create Poker Table UI** as part of the User Interface & Controls lesson.

## Requirements

Create a working implementation that:
1. Implements the core functionality for Create Poker Table UI
...
- Write the JavaScript functions for Create Poker Table UI
