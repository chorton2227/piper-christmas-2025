# Exercise 3: Add UI Animations 🎯

## Objective

In this exercise, you'll practice implementing **Add UI Animations** as part of the User Interface & Controls lesson.

## Requirements

Create a working implementation that:
1. Implements the core functionality for Add UI Animations
...
- Write the JavaScript functions for Add UI Animations
