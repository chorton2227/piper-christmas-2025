# Exercise 1: Basic Dealing 🎯

## Objective

In this exercise, you'll practice implementing **Basic Dealing** as part of the Game Flow & Dealing lesson.

## Requirements

Create a working implementation that:
1. Implements the core functionality for Basic Dealing
...
- Write the JavaScript functions for Basic Dealing
