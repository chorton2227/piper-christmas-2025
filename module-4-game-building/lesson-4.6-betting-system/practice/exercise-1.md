# Exercise 1: Implement Check, Call & Fold 🎯

## Objective

In this exercise, you'll practice implementing **Implement Check, Call & Fold** as part of the Betting System lesson.

## Requirements

Create a working implementation that:
1. Implements the core functionality for Implement Check, Call & Fold
...
- Write the JavaScript functions for Implement Check, Call & Fold
