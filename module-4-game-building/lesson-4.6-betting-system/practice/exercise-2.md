# Exercise 2: Add Raise Logic 🎯

## Objective

In this exercise, you'll practice implementing **Add Raise Logic** as part of the Betting System lesson.

## Requirements

Create a working implementation that:
1. Implements the core functionality for Add Raise Logic
...
- Write the JavaScript functions for Add Raise Logic
