# Exercise 3: Track Betting Rounds 🎯

## Objective

In this exercise, you'll practice implementing **Track Betting Rounds** as part of the Game State Management lesson.

## Requirements

Create a working implementation that:
1. Implements the core functionality for Track Betting Rounds
...
- Write the JavaScript functions for Track Betting Rounds
