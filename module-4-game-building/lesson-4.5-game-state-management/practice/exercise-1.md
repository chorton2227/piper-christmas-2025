# Exercise 1: Create Game State 🎯

## Objective

In this exercise, you'll practice implementing **Create Game State** as part of the Game State Management lesson.

## Requirements

Create a working implementation that:
1. Implements the core functionality for Create Game State
...
- Write the JavaScript functions for Create Game State
