# Student Workspace: Game State Management 🎯

## Welcome!

This is **your workspace** for practicing Game State Management. Use this area to experiment, try new ideas, and build your skills!
...
<head>
    ...
    <title>My Game State Management Practice</title>
    <style>
        body {
...
<body>
    <div class="container">
        <h1>My Game State Management Practice</h1>
