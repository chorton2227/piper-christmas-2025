...
**Parent Guide**: See `resources/parent-guide.md` for tips on helping your child through this lesson.

**Cheat Sheet**: Check `resources/cheatsheet.md` for a quick reference guide.
